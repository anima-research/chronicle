...
pub use state::{
    apply_operation, materialize_operations, ChainStats, CompactionStats, FieldIndexKind,
    FieldIndexManager, SnapshotNeeded, StateChainHead, StateIndex, StateManager,
};
