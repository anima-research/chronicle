...
const SCRIPT = fileURLToPath(
  new URL("./release-changelog.mjs", import.meta.url),
);
...
const changelog = (dir) => readFileSync(join(dir, "CHANGELOG.md"), "utf8");
const pending = (dir) => readdirSync(join(dir, "changelog.d")).sort();
